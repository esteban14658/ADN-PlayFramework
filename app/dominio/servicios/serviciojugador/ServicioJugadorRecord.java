...
public class ServicioJugadorRecord {
    ...
    public ServicioJugadorRecord(){

    }

    public ServicioJugadorRecord(Long id, Long documento, String nombre, String apellido, LocalDate fechaNacimiento,
